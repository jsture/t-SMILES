...
class RDKEnumerateSmiles:
    def enumerate_smiles(
        base_sml, n_samples, code="smiles", isomericSmiles=True, kekuleSmiles=False
    ):  # default values are same as RDKit
        sml_list = []
        s = RDKEnumerateSmiles.randomize_smiles_simple(
            base_sml,
            code,
            canonical=True,
    ...
    def randomize_smiles_simple(
        smiles, code="smiles", canonical=False, isomericSmiles=False, kekuleSmiles=False
    ):
